...
class Main extends React.Component {
  constructor(...props) {
    ...
    this.state = {
      ...
      conversation: [
        { id: 1,
          text: 'Hello, I am Bob, MCMP Virtual Assistant. I can provide you basic information on the MCMP Applications and guide you to perform MCMP Platform Administration functions',
          owner: ''
        }]
    };
    this.startTimer();
          ...
          <Grid.Column width={16}>
            ...
            <Card className='chatbot-container'>
              <Card.Content className='dialog-header'>
                <Card.Header>MCMP Document Search ChatBot</Card.Header>
              </Card.Content>
              <Card.Content>
                {this.getListItems()}
              </Card.Content>
